...
;// CONCATENATED MODULE: ./node_modules/hast-util-to-jsx-runtime/node_modules/estree-util-is-identifier-name/lib/index.js
/**
 * @typedef Options
 *   Configuration.
...
var cjs = __webpack_require__(92209);
...
;// CONCATENATED MODULE: ./node_modules/hast-util-to-jsx-runtime/node_modules/vfile-message/node_modules/unist-util-stringify-position/lib/index.js
/**
 * @typedef {import('unist').Node} Node
 * @typedef {import('unist').Point} Point
 * @typedef {import('unist').Position} Position
...
;// CONCATENATED MODULE: ./node_modules/hast-util-to-jsx-runtime/node_modules/vfile-message/lib/index.js
/**
 * @typedef {import('unist').Node} Node
 * @typedef {import('unist').Point} Point
 * @typedef {import('unist').Position} Position
...
;// CONCATENATED MODULE: ./node_modules/micromark/node_modules/micromark-core-commonmark/node_modules/micromark-factory-destination/index.js
/**
 * @typedef {import('micromark-util-types').Effects} Effects
 * @typedef {import('micromark-util-types').State} State
 * @typedef {import('micromark-util-types').TokenType} TokenType
...
;// CONCATENATED MODULE: ./node_modules/micromark/node_modules/micromark-core-commonmark/node_modules/micromark-factory-label/index.js
/**
 * @typedef {import('micromark-util-types').Effects} Effects
 * @typedef {import('micromark-util-types').State} State
 * @typedef {import('micromark-util-types').TokenizeContext} TokenizeContext
...
;// CONCATENATED MODULE: ./node_modules/micromark/node_modules/micromark-core-commonmark/node_modules/micromark-factory-title/index.js
/**
 * @typedef {import('micromark-util-types').Code} Code
 * @typedef {import('micromark-util-types').Effects} Effects
 * @typedef {import('micromark-util-types').State} State
...
;// CONCATENATED MODULE: ./node_modules/micromark/node_modules/micromark-core-commonmark/node_modules/micromark-factory-whitespace/index.js
/**
 * @typedef {import('micromark-util-types').Effects} Effects
 * @typedef {import('micromark-util-types').State} State
 */
...
;// CONCATENATED MODULE: ./node_modules/micromark/node_modules/micromark-core-commonmark/node_modules/micromark-util-html-tag-name/index.js
/**
...
;// CONCATENATED MODULE: ./node_modules/micromark/node_modules/micromark-core-commonmark/node_modules/micromark-util-classify-character/index.js
/**
 * @typedef {import('micromark-util-types').Code} Code
 */
...
;// CONCATENATED MODULE: ./node_modules/micromark-util-sanitize-uri/node_modules/micromark-util-character/index.js
/**
 * @typedef {import('micromark-util-types').Code} Code
 */
...
function normalizeUri(value) {
  ...
  while (++index < value.length) {
    ...
    if (
      code === 37 &&
      micromark_util_character_asciiAlphanumeric(value.charCodeAt(index + 1)) &&
      micromark_util_character_asciiAlphanumeric(value.charCodeAt(index + 2))
    ) {
      skip = 2
    }
    // ASCII.
...
;// CONCATENATED MODULE: ./node_modules/mdast-util-to-hast/node_modules/unist-util-visit/node_modules/unist-util-is/lib/index.js
/**
 * @typedef {import('unist').Node} Node
...
;// CONCATENATED MODULE: ./node_modules/mdast-util-to-hast/node_modules/unist-util-visit/node_modules/unist-util-visit-parents/lib/color.node.js
/**
 * @param {string} d
 * @returns {string}
 */
...
;// CONCATENATED MODULE: ./node_modules/mdast-util-to-hast/node_modules/unist-util-visit/node_modules/unist-util-visit-parents/lib/index.js
/**
...
;// CONCATENATED MODULE: ./node_modules/mdast-util-to-hast/node_modules/unist-util-visit/lib/index.js
/**
 * @typedef {import('unist').Node} UnistNode
 * @typedef {import('unist').Parent} UnistParent
...
;// CONCATENATED MODULE: ./node_modules/unified/node_modules/vfile/node_modules/unist-util-stringify-position/lib/index.js
/**
 * @typedef {import('unist').Node} Node
 * @typedef {import('unist').Point} Point
 * @typedef {import('unist').Position} Position
...
;// CONCATENATED MODULE: ./node_modules/unified/node_modules/vfile/node_modules/vfile-message/lib/index.js
/**
 * @typedef {import('unist').Node} Node
 * @typedef {import('unist').Point} Point
 * @typedef {import('unist').Position} Position
...
class VFile {
  ...
  constructor(value) {
     ...
     * @type {string}
     */
    this.cwd = external_node_process_default().cwd()
   ...
   */
  get basename() {
    return typeof this.path === 'string' ? external_node_path_default().basename(this.path) : undefined
  }
  ...
  set basename(basename) {
    ...
    this.path = external_node_path_default().join(this.dirname || '', basename)
  }
   ...
   */
  get dirname() {
    return typeof this.path === 'string' ? external_node_path_default().dirname(this.path) : undefined
  }
  ...
  set dirname(dirname) {
    ...
    this.path = external_node_path_default().join(dirname || '', this.basename)
  }
   ...
   */
  get extname() {
    return typeof this.path === 'string' ? external_node_path_default().extname(this.path) : undefined
  }
  ...
  set extname(extname) {
    ...
    this.path = external_node_path_default().join(this.dirname, this.stem + (extname || ''))
  }
  ...
  get stem() {
    return typeof this.path === 'string'
      ? external_node_path_default().basename(this.path, this.extname)
      : undefined
  }
  ...
  set stem(stem) {
    ...
    this.path = external_node_path_default().join(this.dirname || '', stem + (this.extname || ''))
  }
...
function assertPart(part, name) {
  if (part && part.includes((external_node_path_default()).sep)) {
    throw new Error(
      '`' + name + '` cannot be a path: did not expect `' + (external_node_path_default()).sep + '`'
    )
  }
}
...
;// CONCATENATED MODULE: ./node_modules/react-markdown/node_modules/unist-util-visit/node_modules/unist-util-is/lib/index.js
/**
 * @typedef {import('unist').Node} Node
 * @typedef {import('unist').Parent} Parent
 */
...
;// CONCATENATED MODULE: ./node_modules/react-markdown/node_modules/unist-util-visit/node_modules/unist-util-visit-parents/lib/color.node.js
/**
 * @param {string} d
 * @returns {string}
 */
...
;// CONCATENATED MODULE: ./node_modules/react-markdown/node_modules/unist-util-visit/node_modules/unist-util-visit-parents/lib/index.js
/**
 * @typedef {import('unist').Node} UnistNode
 * @typedef {import('unist').Parent} UnistParent
 */
 ...
 *   `unist-util-is`-compatible test.
 */
function lib_visitParents(tree, test, visitor, reverse) {
  /** @type {Test} */
  let check
  ...
  function factory(node, index, parents) {
    ...
    function visit() {
      ...
      if ('children' in node && node.children) {
        ...
        if (nodeAsParent.children && result[0] !== lib_SKIP) {
          offset = (reverse ? nodeAsParent.children.length : -1) + step
          grandparents = parents.concat(nodeAsParent)
...
;// CONCATENATED MODULE: ./node_modules/react-markdown/node_modules/unist-util-visit/lib/index.js
/**
 * @typedef {import('unist').Node} UnistNode
 * @typedef {import('unist').Parent} UnistParent
 * @typedef {import('unist-util-visit-parents').VisitorResult} VisitorResult
...
;// CONCATENATED MODULE: ./node_modules/react-markdown/node_modules/vfile/node_modules/unist-util-stringify-position/lib/index.js
/**
 * @typedef {import('unist').Node} Node
 * @typedef {import('unist').Point} Point
 * @typedef {import('unist').Position} Position
...
function node_modules_unist_util_stringify_position_lib_stringifyPosition(value) {
  ...
  // Point.
  if ('line' in value || 'column' in value) {
    return vfile_node_modules_unist_util_stringify_position_lib_point(value)
  }
 ...
 * @returns {string}
 */
function vfile_node_modules_unist_util_stringify_position_lib_point(point) {
...
function vfile_node_modules_unist_util_stringify_position_lib_position(pos) {
  return vfile_node_modules_unist_util_stringify_position_lib_point(pos && pos.start) + '-' + vfile_node_modules_unist_util_stringify_position_lib_point(pos && pos.end)
}
...
;// CONCATENATED MODULE: ./node_modules/react-markdown/node_modules/vfile/node_modules/vfile-message/lib/index.js
/**
 * @typedef {import('unist').Node} Node
 * @typedef {import('unist').Point} Point
 * @typedef {import('unist').Position} Position
...
class vfile_message_lib_VFileMessage extends Error {
  ...
  constructor(causeOrReason, optionsOrParentOrPlace, origin) {
     ...
     * `VFile` messages we use this space to show where an error happened.
     */
    this.name = node_modules_unist_util_stringify_position_lib_stringifyPosition(options.place) || '1:1'
...
vfile_message_lib_VFileMessage.prototype.column = undefined
vfile_message_lib_VFileMessage.prototype.line = undefined
vfile_message_lib_VFileMessage.prototype.ancestors = undefined
vfile_message_lib_VFileMessage.prototype.cause = undefined
vfile_message_lib_VFileMessage.prototype.fatal = undefined
vfile_message_lib_VFileMessage.prototype.place = undefined
vfile_message_lib_VFileMessage.prototype.ruleId = undefined
vfile_message_lib_VFileMessage.prototype.source = undefined
...
class lib_VFile {
  ...
  constructor(value) {
    ...
    if (!value) {
      ...
      options = {path: value}
    } else if (typeof value === 'string' || vfile_lib_isUint8Array(value)) {
      options = {value}
    } else {
      options = value
    }
   ...
   */
  message(causeOrReason, optionsOrParentOrPlace, origin) {
    const message = new vfile_message_lib_VFileMessage(
      // @ts-expect-error: the overloads are fine.
      causeOrReason,
      optionsOrParentOrPlace,
      origin
 ...
 *   Whether `value` is an `Uint8Array`.
 */
function vfile_lib_isUint8Array(value) {
  return Boolean(
    value &&
      typeof value === 'object' &&
      'byteLength' in value &&
